    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
          Maximum file size: No Maximum file size but the recommend size
          is 100MB. Higher than 100mb TAKES LONGER TIME DEPENDING ON YOUR NETWORK. Supported formats: MP4, WebM, MOV
        </p>
      </div>
