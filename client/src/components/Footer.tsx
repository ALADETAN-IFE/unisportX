    ...
    <footer className="bg-gray-900 text-gray-200 py-8">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-start gap-2 mb-4 md:mb-0">
          <img src="/logo.png" className='max-w-full h-12'/>
        ...
        <nav className="flex flex-wrap gap-6 text-sm font-medium">
          ...
          <span onClick={scrollToTop} className="hover:text-blue-400 transition cursor-pointer">About</span>
        </nav>
        {/* Tagline & Socials */}
        <div className="flex flex-col items-center md:items-end gap-2">
          <span className="text-xs opacity-80">For athletes, fans, and everyone in the university community.</span>
          ...
          <span className="text-xs opacity-60 mt-2">&copy; {new Date().getFullYear()} UniSportX. All rights reserved.</span>
        </div>
      </div>
    </footer>
  );
